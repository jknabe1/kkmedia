  ...
  return (
	...
	<div className="container flex flex-col justify-between pt-10 pb-[90px] mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			...
			<p>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quo? Conse
			</p>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<Link rel="noopener noreferrer" href="../pages/author">Vi skriver</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="#">Full transparens </Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
